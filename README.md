...
Customer Demographics: Segmented the customer base into three categories, revealing that Adults (50.01%) are the primary revenue drivers, followed by Teenagers and Seniors.

Product Analysis: Identified top-performing categories by quantity, with "Sets" (12.4K) and "Kurtas" (10.5K) emerging as the most popular items.

Channel Performance: Evaluated sales across platforms like Amazon, Myntra, Flipkart, Ajio, and Meesho, with Amazon clearly leading in order volume.
...
Data Modeling: Established relationships between sales, geography, and product tables.
